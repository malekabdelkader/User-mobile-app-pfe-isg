...
/***/ "./src/app/shared/abonnement.service.ts":
/*!**********************************************!*\
  !*** ./src/app/shared/abonnement.service.ts ***!
  \**********************************************/
...
var AbonnementService = /** @class */ (function () {
    // Inject AngularFireDatabase Dependency in Constructor
    function AbonnementService(db) {
        this.db = db;
    }
    // Create Abonnement
    AbonnementService.prototype.AjouterAbonnement = function (Abonnement) {
...
var UserService = /** @class */ (function () {
    ...
    // Create User
    UserService.prototype.AjouterUser = function (User) {
        this.UsersRef.push({
            nom: User.nom,
            prenom: User.prenom,
    ...
    // Update User Object
    UserService.prototype.ModifierUser = function (User) {
        this.UserRef.update({
            nom: User.nom,
            prenom: User.prenom,
            password: User.password,
    ...
    // Delete User Object
    UserService.prototype.SupprimerUser = function (id) {
        this.UserRef = this.db.object('users/' + id);
        this.UserRef.remove();
    };
